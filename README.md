...
-   **`ehe_demografico()`**: Calcula indicadores sociodemográficos para
    la población de 14 años y más, incluyendo población total,
    distribución por sexo, grupos de edad, sexo y grupo de edad y
    jefatura del hogar.
...
La función `ehe_demografico()` permite calcular indicadores
sociodemográficos para la población de 14 años y más.
...
La función utiliza el factor de expansión `ponduni` y calcula:

-   población de 14 años y más;
-   distribución por sexo;
-   distribución por grupos de edad;
-   distribución conjunta por sexo y grupo de edad;
-   cantidad y proporción de jefes de hogar.

Los grupos de edad utilizados son:

-   de 14 a 29 años;
-   de 30 a 64 años;
-   65 años y más.

La función construye internamente las variables derivadas necesarias
para estos indicadores, por lo que no es necesario crearlas previamente
en la base.
...
# Calcular indicadores sociodemográficos
ehe_demografico(
  base = base
)
