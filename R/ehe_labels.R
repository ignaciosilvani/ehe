...
#' utilizando el diseño de registro correspondiente.
#'
#' @param data Base de datos EHE.
#' @param dictionary Diccionario obtenido con [ehe_dictionary()].
#' Si es `NULL`, se obtiene automáticamente.
...
ehe_labels <- function(
  ...
  for (variable in variables) {
    ...
    # Si no tiene categorías, continúa
    ...
    # numéricas que poseen categorías en el diccionario.
